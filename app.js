...
function getLocation() {
    ...
    statusText.innerText = "⏳ Localizando..."; gpsBtn.disabled = true;
    navigator.geolocation.getCurrentPosition(
        (position) => {
            userCoordinates = `https://www.google.com/maps?q=${position.coords.latitude},${position.coords.longitude}`;
            statusText.innerHTML = `✅ ¡Ubicación capturada!`; statusText.style.color = "#25D366"; gpsBtn.disabled = false;
        },
        () => { statusText.innerText = "❌ Error al obtener GPS."; gpsBtn.disabled = false; },
