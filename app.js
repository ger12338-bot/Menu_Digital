...
// ==========================================================================
// 5. CÁLCULO DE DISTANCIA HAVERSINE Y TARIFA DE ENVÍO
// ==========================================================================
...
function calculateShippingFee(distanceMeters) {
    if (distanceMeters <= 300) {
        ...
        return (distanceMeters / 100) * 2.00;
    }
}
...
function getLocation() {
    ...
    statusText.innerText = "⏳ Localizando y calculando envío..."; 
    ...
    navigator.geolocation.getCurrentPosition(
        (position) => {
            ...
            deliveryDistanceMeters = calculateHaversineDistance(STORE_LAT, STORE_LNG, userLat, userLng);
            ...
            statusText.innerHTML = `✅ ¡Ubicación capturada! (${distKm} km - ${costoTexto})`; 
...
function sendOrder(event) {
    ...
    // FORMATO DE PLATILLOS IDENTICO AL POS (CON PRECIO UNITARIO E IMPORTE)
    ...
    // RENGLÓN EXCLUSIVO DE ENVÍO IGUAL QUE EN EL POS
    if (userCoordinates) {
