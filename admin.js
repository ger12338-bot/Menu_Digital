// ==========================================================================
// CONFIGURACIÓN DE ENDPOINTS Y VARIABLES GLOBALES
// ==========================================================================
// URL del Web App de Google Apps Script. Si cambias de script, actualiza esta URL.
...
let datosFilas = [];            // Almacena todos los pedidos cargados
let filasFiltradasGlobal = [];  // Pedidos filtrados visibles en pantalla
let filtroCanalActual = 'todos';// Canal activo ('todos', 'WhatsApp', 'Local')
let filtroFechaActual = 'hoy';  // Rango fecha activo ('hoy', 'ayer', 'semana', 'todo')
let estadoTiendaActual = "ABIERTO"; // Estado de la cocina en Google Sheets
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Auto-actualización silenciosa cada 30 segundos (30000 ms)
    setInterval(() => {
...
// ==========================================================================
// 1. CARGA DE PEDIDOS DESDE GOOGLE SHEETS
// ==========================================================================
function sincronizarDatosGrid(esSilencioso = false) {
    ...
    // Petición GET pidiendo la acción getPedidos
    fetch(`${GOOGLE_SCRIPT_URL}?action=getPedidos`, { method: "GET", redirect: "follow" })
    .then(res => res.json())
    .then(data => {
        if (Array.isArray(data)) {
            // Invertimos el arreglo para mostrar los pedidos más recientes arriba
...
// ==========================================================================
// 2. CONTROL DEL INTERRUPTOR MAESTRO (ABRIR / CERRAR TIENDA)
// ==========================================================================
...
// ==========================================================================
// 3. SELECCIÓN DE FILTROS DE CANAL Y FECHA
// ==========================================================================
...
// Convertidor para interpretar la fecha escrita por Google Sheets (DD/MM/YYYY)
...
// ==========================================================================
// 4. LÓGICA DE FILTRADO Y RENDERIZADO EN TABLA
// ==========================================================================
function filtrarTabla() {
    ...
    // Dibujamos cada renglón dinámicamente
...
// ==========================================================================
// 5. MODAL DE DETALLE Y MANEJO DE ERRORES
// ==========================================================================
...
// Cerrar el modal al hacer clic en cualquier lugar fuera de la ventana blanca/oscura
