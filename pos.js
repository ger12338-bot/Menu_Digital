                ...
                card.innerHTML = `
                    <div style="display:flex; flex-direction:column; max-width:58%;">
                        ...
                        <div style="display:flex; align-items:center; gap:6px; margin: 2px 0;">
                            ...
                            <!-- SELECT EDICIÓN DE MÉTODO DE PAGO EN HISTORIAL -->
                            <select class="select-metodo-historial" onchange="cambiarMetodoPagoHistorial('${v.id || v.id_pedido || ''}', this.value, ${v.indexReal})">
...
function cambiarMetodoPagoHistorial(idPedido, nuevoMetodo, indexReal) {
