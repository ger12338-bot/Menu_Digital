...
// ==========================================================================
// 6. REGISTRO DE VENTA (INCLUYE PRECIO UNITARIO Y SUBTOTAL)
// ==========================================================================
function procesarVentaPOS() {
    ...
    // FORMATO OPCIÓN B: Cantidad, Nombre, Precio Unitario y Subtotal
    let productosString = Object.keys(cart).map(id => {
        const item = cart[id];
        const subtotal = item.price * item.quantity;
...
// ==========================================================================
// 7. FUNCIONALIDAD PARA AGREGAR PRODUCTOS ESPECIALES / LIBRES
// ==========================================================================
